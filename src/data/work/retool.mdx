...
<div className="flex breakout h-20 items-center justify-center dark:bg-amber-950 dark:text-amber-400 bg-amber-100 text-amber-600 uppercase border-y-4 border-dashed border-current/40">
