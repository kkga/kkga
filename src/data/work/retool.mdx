...
<div className="flex breakout h-20 items-center justify-center bg-amber-100 text-amber-600 uppercase">
  <Image width={32} height={32} class="size-6 mr-2" src="http://textfiles.com/underconstruction/ReResearchTriangle7711imagesconstruction-a.gif" alt="Under Construction" />
