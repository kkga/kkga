...
import jotdown from "../img/dlog/jotdown.mp4";
...
well-designed learning experience). It got me hooked.
...
`<textarea>`'s slapped together. I've been using [Tot](https://tot.rocks/) on
...
throughout the day. Source code is available
[on GitHub](https://github.com/kkga/jotdown).

<Video className="breakout" src={jotdown} />
