...
function ListItem({ title, url, description, date }) {
  return (
    <li className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 leading-tight">
      <a
        href={url}
      ...
      <div className="hidden sm:block basis-16 flex-1 mt-1 border-t-2 h-1 border-dotted border-gray-400">
      </div>
      {description &&
        (
